      ...
      <div className="app">
        ...
        <section className="form-wrap">
          ...
          <form id="verifyForm" onSubmit={(e) => this.onSubmitVerification(e)}>
            <input type="Username" placeholder="Username" value={this.state.username}/>
            <input type="text" placeholder="Verification Code" value={this.state.code} onChange={(e) => this.onCodeChanged(e)}/>
